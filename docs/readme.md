...
2. Local setup of spark. This is tricky so keep all things intact to work it properly.Download python 3.7 instead of python3.6 or python3.9 
...
8. To monitor while running project use link- http://localhost:4040/jobs/
...
![Architecture]( D:\Industry_DE_project\Industry_project1\docs\architecture.png )

Database ER Diagram:-
![Architecture]( D:\Industry_DE_project\Industry_project1\docs\database_schema.drawio.png )

If you get stuck, don't forget to reach out to me www.linkedin.com/in/gaurav-data-engineer