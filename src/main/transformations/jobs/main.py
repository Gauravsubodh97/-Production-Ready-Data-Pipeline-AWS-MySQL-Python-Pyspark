...
from Industry_project1.resources.dev import config
from Industry_project1.src.main.delete.local_file_delete import delete_local_file
from Industry_project1.src.main.move.move_files import move_s3_to_s3
from Industry_project1.src.main.read.database_read import DatabaseReader
from Industry_project1.src.main.transformations.jobs.customer_mart_sql_tranform_write import \
    customer_mart_calculation_table_write
from Industry_project1.src.main.transformations.jobs.dimension_tables_join import dimesions_table_join
from Industry_project1.src.main.transformations.jobs.sales_mart_sql_transfrom_write import \
    sales_mart_calculation_table_write
from Industry_project1.src.main.upload.upload_to_s3 import UploadToS3
from Industry_project1.src.main.utility.encrypt_decrypt import *
from Industry_project1.src.main.utility.logging_config import *
from Industry_project1.src.main.utility.s3_client_object import *
from Industry_project1.src.main.utility.my_sql_session import *
from Industry_project1.src.main.read.aws_read import *
from Industry_project1.src.main.download.aws_file_download import *
from Industry_project1.src.main.utility.spark_session import spark_session
from Industry_project1.src.main.write.parquet_writer import ParquetWriter
...
# if not required column keep it in a list or error_files
...
logger.info("******************* Fixed Extra column coming from Source *********************")
...
# connecting with DatabasesReader
...
for data in correct_files:
    ...
    if extra_columns:
        data_df = data_df.withColumn("additional_column",
            ...
            .select("customer_id", "store_id", "product_name", "sales_data", "sales_person_id"
...
logger.info("********************* Write teh data into sales team Data Mart *********************")
...
# Move data on s3 bucket foe sales_data_mart
...
source_prefix = config.s3_processed_directory
...
logger.info("************* Deleting customer datamart local file from local *************")
delete_local_file(config.customer_data_mart_local_file)
logger.info("*************** Deleted customer data mart local file from local ***************")

logger.info("************* Deleting sales team data mart local file from local *************")
delete_local_file(config.sales_team_data_mart_local_file)
logger.info("*************** Deleted sales team data mart local file from local ***************")

logger.info("****** Deleting sales team data mart partitioned local file from local ******")
delete_local_file(config.sales_team_data_mart_partitioned_local_file)
logger.info("****** Deleted sales team data mart partitioned local file from local ******")
